from core.entities.billing_schema import TransactionInfo
...
class BillingService(BaseService):
    ...
    def get_transaction_history(self, user_id: int) -> [TransactionInfo]:
        ...
        transaction_infos = [
            TransactionInfo(id=t.id, amount=t.amount, timestamp=t.created_at)
    ...
    def reserve_funds(self, user_id: int, amount: int) -> bool:
        current_balance, reserved_funds = (
            self.billing_repository.get_balance_and_reserved_funds(user_id)
        )
